...
>   - در Investment-Crypto: برای IRR/USDT، `totalInvested = 0` و `totalFeesPaid = 0` در `inv_crypto_holdings`  
>   - در Investment-Stocks-Iran: موجودی نقدی کارگزاری در `inv_stocks_iran_brokerage_transactions` ذخیره می‌شود  
