...
Every Feature completes RAW/DERIVED/SNAPSHOT/EXTERNAL_REPORTED/LABEL/SYSTEM_INDEX + Owner + Editable + SoT + Rebuild + Migration per field. See `P1-GLOBAL-CONTRACTS.md`. No field dropped only for being “old”.
