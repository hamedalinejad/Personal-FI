...
## 1. Purpose
Fund subscribe/redeem/distribution with NAV vs transaction price.

## 2. Scope
subscribe, redeem, distribution; reinvestment DEFERRED if OPEN.
...
## 7. Fields
NAV, transactionPrice, liquidationPrice — never infer liquidation from NAV.
