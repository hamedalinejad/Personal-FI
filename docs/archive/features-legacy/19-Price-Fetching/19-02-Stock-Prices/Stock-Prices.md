...
1. ابزارهایی که قیمت‌گیری می‌شوند از `DISTINCT instrumentId` روی `inv_stocks_iran_holdings` (همراه mapping Provider) و ETFهای `inv_fif_holdings` با `fundType='etf'` استخراج می‌شوند — نه صرفاً `symbol` نمایشی.
