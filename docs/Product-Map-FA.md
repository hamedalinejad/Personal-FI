...
دریافت دستی قیمت لحظه‌ای دارایی‌ها (رمزارز در نسخه ۱؛ سهام، مسکن و فلزات در آینده) از API بیرونی، با کش آفلاین کامل. صفحه مستقل ندارد و از داخل صفحه سرمایه‌گذاری/تنظیمات استفاده می‌شود.